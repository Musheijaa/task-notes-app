...
/// App-wide semantic colors (success, warning, danger, priority badges)
/// Kept here to avoid hard-coding colors across widgets.
class LightSemanticColors {
...
class DarkSemanticColors {
  // Slightly softened for dark mode while maintaining contrast
  static const success = Color(0xFF63C976);
  static const warning = Color(0xFFF2CD36);
  static const danger = Color(0xFFE96161);
}

/// Convenience helpers to fetch semantic colors for current theme.
class SemanticColors {
  static bool _isDark(BuildContext context) =>
      Theme.of(context).brightness == Brightness.dark;

  static Color success(BuildContext context) =>
      _isDark(context) ? DarkSemanticColors.success : LightSemanticColors.success;

  static Color warning(BuildContext context) =>
      _isDark(context) ? DarkSemanticColors.warning : LightSemanticColors.warning;

  static Color danger(BuildContext context) =>
      _isDark(context) ? DarkSemanticColors.danger : LightSemanticColors.danger;

  static Color priorityHigh(BuildContext context) => danger(context);
  static Color priorityMedium(BuildContext context) => warning(context);
  static Color priorityLow(BuildContext context) => success(context);
}
